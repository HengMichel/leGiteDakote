...
<div class="container">
    ...
    <div class="descriptionDescriptif border border-4 border-warning mt-5">
        <h3>Descriptif</h3>
        ...
        <p class="p2bis">Vous aimez la mer, les sports nautiques, les belles randonnées et la nature préservée? Vous êtes au bon endroit! Le petit port touristique et animé de l'Aber Wrac'h est également réputé pour son centre nautique, les bateaux, ses magnifiques panoramas sur l'Aber et le phare de l'île Vierge, l'île Wrac'h, ... Les dunes Ste Marguerite sont également connues pour ses spots de kite-surf et de planche à voile, ses dunes sauvages, ses magnifiques randonnées, ses plages de sable blanc et eaux turquoises au pays des huîtres.</p>
    </div>
    <div class="proprio">
       <h4>Les propriétaires</h4>
       <div class="photoProfile">
           <p><span>Jacqueline et Lucien</span></p>
           <img class="pro border border-4 border-success" src="/leGiteDakote/public/assets/imgs/les_proprio.jpg " alt="">
       </div>
    </div>
    <div class="local mt-3 link-warning">
        <h3>Localisation</h3>
    </div>
    <iframe class="map mt-3 border border-4 border-warning" width="100%" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2628.7214751326624!2d2.3966389!3d48.7872074!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e6739a5f64b489%3A0x5fa105b2ca801da8!2sCentre%20des%20Finances%20Publiques!5e0!3m2!1sfr!2sfr!4v1698741539012!5m2!1sfr!2sfr" width="1200" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
</h1>