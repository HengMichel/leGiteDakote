    ...
    <table class="table table-hover mt-5">
      ...
      <tbody>
        <tr class="table-active">
          ...
          <td class="idUser border bg-secondary link-light"><?= $users->getId_user() 
          ?></td>
        </tr>
        <tr class="table">
          <th scope="row" class="lastname bg-secondary link-light border align-middle text-center">Nom</th>
          <td class="last_name border bg-secondary link-light"><?= $users->getLast_name() ?></td>
        </tr>
        <tr class="table">
          <th scope="row" class="firstname bg-secondary link-light border align-middle text-center">Prénom</th>
          <td class="firstname2 border bg-secondary link-light"><?= $users->getFirst_name() ?></td>
        </tr>
        <tr class="table">
          <th scope="row"  class="email bg-secondary link-light border align-middle text-center">Email</th>
          <td class="email2 border bg-secondary link-light"><?= $users->getEmail() ?></td>
        </tr>
        <tr class="table">
          <th scope="row" class="password bg-secondary link-light border align-middle text-center">Mot de passe</th>
          <td class="password2 border bg-secondary link-light"><?= $users->getPassword() ?></td>
        </tr>
        <tr class="table">
          <th scope="row" class="role bg-secondary link-light border align-middle text-center">Role</th>
          <td class="role2 border bg-secondary link-light"><?= $users->getRole() ?></td>
        </tr>
        <tr class="table">
          <th scope="row" class="birthday bg-secondary link-light border align-middle text-center">Anniversaire</th>
          <td class="birthday2 border bg-secondary link-light"><?= date("d-m-Y", strtotime($users->getBirthday())) ?></td>
        </tr>
        <tr class="table">
          <th scope="row" class="adress bg-secondary link-light border align-middle text-center">Adresse</th>
          <td class="adress2 border bg-secondary link-light"><?= $users->getAddress() ?></td>
        </tr>
        <tr class="table">
          <th scope="row" class="phone_number bg-secondary link-light border align-middle text-center">Numéro de tel</th>
          <td class="phone_number2 border bg-secondary link-light"><?= $users->getPhone_number() ?></td>
        </tr>
        <tr class="table">
          <th scope="row" class="gender bg-secondary link-light border align-middle text-center">Civilité</th>
          <td class="gender2 border bg-secondary link-light"><?= $users->getGender() ?></td>
        </tr>
        <tr class="table">
