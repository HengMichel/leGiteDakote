...
<div class="container5 container">
    <form method="post">
        ...
        <div class="form-group mt-5 mb-5 d-flex">
            <label class="me-xl-5 link-warning bg-dark fw-medium">Gender :
            </label>
        ...
        <div class="row">
            <div class="form-group col-md-6">
                <label class="firstname bg-dark fw-medium link-warning" for="firstname">Firstname :
                </label>
                <input type="text" class="form-control border-success border-4 mt-3 bg-success-subtle fw-medium" id="firstname" name="firstname" value="<?= $users->getFirstname() ?>" <?= $mode == "suppression" ? "disabled" : "" ?>>
            </div>
    
            <div class="form-group col-md-6">
                <label class="lastname link-warning bg-dark fw-medium" for="lastname">Lastname :</label>
                <input type="text" class="form-control border-success border-4 mt-3 bg-success-subtle fw-medium" id="lastname" name="lastname"  value="<?= $users->getLastname() ?>" <?= $mode == "suppression" ? "disabled" : "" ?>>
            </div>
            <div class="form-group mt-3 col-md-6">
                <label class="email link-warning bg-dark fw-medium" for="email">Email :
                </label>
            ...
            <div class="form-group mt-3 col-md-6">
                ...
                <input type="text" class="form-control border-success border-4 mt-3 bg-success-subtle fw-medium" name="phone" value="<?= $users->getPhone_number() ?>" <?= $mode == "suppression" ? "disabled" : "" ?>>
            </div>    
        </div>
        ...
        <button type="submit" id="bouton" class="btn mt-5   mb-5 border-warning border-4 mt-2 bg-success link-warning m-auto" name="submit"><?= $mode == "suppression" ? "Confirmer" : "Enregistrer" ?>
        </button>
