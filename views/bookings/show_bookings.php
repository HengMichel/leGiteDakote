    ...
    <table class="table table-hover mt-5 container">
        ...
        <tbody>
            ...
            // foreach ($panier as $item) {
                ...
                // Vérifier le type de l'élément du panier est une instance de Model\Entity\Bookings
                // if ($item instanceof Model\Entity\Bookings) {
                ...
                //     echo '<td class="IdBooking text-center border-secondary">' . ($item['id_booking'] ?? '') . '</td>';
            ...
            //         echo '<td class="bookRoomId text-center border-secondary">' . $item->getId_booking() . '</td>';
 ...
 <div class="container5 ">
    <table class="table table-hover mt-5 bg-success-subtle">
        ...
        <tbody>
            ...
            foreach ($panier as $item) {
                if ($item instanceof Model\Entity\Bookings) { // Vérifier si l'élément est une instance de Model\Entity\Bookings
                    // Ajouter le prix au total
                    $totalPrice += floatval($item->getBooking_price());
            ?>

            <tr class="table-active">
                <td class="idbook border-success-subtle border-3 mt-2 col-1 align-middle fs-5 text-center fw-semibold"><?= $item->getId_booking() ?></td>
