...
<!-- présentation des propriétaire -->
        ...
        <button type="button" class="btn btn-outline-warning  fw-bold">
            <a class="nav-link active link-light" aria-current="page" href="<?= addLink("home") ?>">Accueil
            </a>
        </button>
...
<!-- connexion avec le message Bienvenue suivi du nom -->
            <?php
                if( $user = Session::getConnectedUser() ): 
            ?>
        <button type="button" class="btn btn-outline-warning fw-bolder">
            <a class="nav-link"
                    href="<?= addLink("users", "show", $user->getId_user()) ?>">
        ...
        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
            ...
            <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
                    ...
                    <a class="dropdown-item fw-bolder" href="<?= addLink('admin/category', 'new') ?>">Ajouter</a>
                </div>
            </div>
            <?php endif; ?>
        </div>
...
<!-- access aux services  -->
        <button type="button" class="btn btn-outline-warning fw-bolder">
            <a class="nav-link link-light fw-bold" href="<?= addLink("home","serviceDuGite") ?>">Nos Services
            </a>
        </button>

<!-- inscription -->
        <button type="button" class="btn btn-outline-warning fw-bold">
            <a class="nav-link link-light fw-bold" href="<?= addLink("users","newUsers") ?>">Inscription</a>
        </button>

<!-- présentation des propriétaire -->
        <button type="button" class="btn btn-outline-warning fw-bold">
            <a class="nav-link link-light fw-bold" href="<?= addLink("home","aboutUs") ?>">à propos de nous</a>
        </button>
    </nav>
</div>
